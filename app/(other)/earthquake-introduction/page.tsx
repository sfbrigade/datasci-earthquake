import { Flex, Link, Text, Box, Heading, List, HStack } from "@chakra-ui/react";
    ...
    >
      <HStack alignItems={"start"} w={{ base: "full", lg: "3/4" }}>
        <div>
          ...
          <Text as="p" mt="2">
            You’ve seen words like “soft story” and “retrofit” floating around,
          ...
          <List.Root textStyle="textMedium" layerStyle="list" mt="0">
            <List.Item>
              ...
              (or “soft”) level, such as a garage or retail space, below one or
              more living spaces.
            </List.Item>
            <List.Item>
              Earthquake retrofitting is the process of strengthening a building
              to make it safer in an earthquake, such as adding structural
              reinforcements or upgrading the foundation to better withstand
              shaking.
            </List.Item>
            <List.Item>
              San Francisco’s Mandatory Soft Story Retrofit Ordinance, enacted
              in 2013, requires all multi-unit soft story buildings built before
              1978 to be retrofitted in order to minimize the risk of earthquake
              damage. Soft-story homes with 1 to 4 units are still vulnerable to
              earthquake damage, even though the ordinance does not legally
              require them to be retrofitted.
            </List.Item>
          </List.Root>
...
export default EarthquakeIntroduction;
