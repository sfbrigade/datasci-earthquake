...
const AboutUs = () => {
  ...
  return (
    <>
      <Flex py="8" px="8" gap="11" direction="column" m="auto">
        <Flex direction="column" alignItems={"flex-start"} gap="12">
          ...
          <Text textStyle="textBig" layerStyle="text">
            ...
            years. SafeHome was created to give San Franciscans the knowledge
            and confidence to feel safe in an earthquake of any size. Using
            public data from the City of San Francisco, our user-friendly tools
            help you understand your home’s seismic stability and take practical
          ...
          <VStack>
            ...
            <Text textStyle="textMedium" layerStyle="text">
              ...
              around high-risk residential buildings—such as soft story
              buildings that haven’t been retrofitted, and older concrete
              structures—and to provide easily accessible tools to help you make
              informed decisions earthquake safety.
            </Text>
          </VStack>
          <VStack alignItems="flex-start">
            ...
            <Text textStyle="textMedium" layerStyle="text">
              SafeHome uses up-to-date official public datasets to power the
              maps and information displayed to users. Our technologists and
              data scientists have rigorously analyzed the Soft Story Properties
              dataset, which includes compliance tiers and statuses for
              soft-story buildings, defined as structures with wood-frame
              structures containing five or more residential units and having
              two or more stories over a soft&quot; or weak&quot; story. We’ve
              also compiled publicly available data to visualize other
              earthquake-related hazards, such as liquefaction and tsunami
              zones.
            </Text>
            <Text textStyle="textMedium" layerStyle="text">
          ...
          <VStack alignItems="flex-start">
            ...
            <Text>
              ...
              {buildLink(
                "mailto:hello@sfcivictech.org",
                "hello@sfcivictech.org"
              )}
              . Friendly reminder: our team is run entirely by volunteers and it
              may take some time to direct your message to the right folks!
