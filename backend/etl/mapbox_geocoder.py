...
_MAPBOX_SOFT_STORY_JSON = "backend/etl/mapbox_soft_story.geojson"
_MAPBOX_BATCH_LIMIT = 1000


class BatchMapboxGeocoder:
    url: str
    api_key: str
