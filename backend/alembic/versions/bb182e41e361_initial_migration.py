...
Revision ID: bb182e41e361
Revises: 
Create Date: 2024-12-13 18:53:14.029615
...
def downgrade() -> None:
    ...
    op.create_table(
        "address",
        sa.Column("eas_baseid", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column("eas_subid", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "eas_fullid", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
        sa.Column(
            "address", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
        sa.Column(
            "unit_number", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("address_number", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
        ...
        sa.Column(
            "street_name", sa.VARCHAR(length=255), autoincrement=False, nullable=False
        ),
        sa.Column(
            "street_type", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "parcel_number", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("block", sa.VARCHAR(length=255), autoincrement=False, nullable=True),
        sa.Column("lot", sa.VARCHAR(length=255), autoincrement=False, nullable=True),
        ...
        sa.Column("point", sa.NullType(), autoincrement=False, nullable=False),
        sa.Column(
        ...
        sa.Column(
            "supdistpad", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "numbertext", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "supname", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("nhood", sa.VARCHAR(length=255), autoincrement=False, nullable=True),
        sa.Column(
        ...
        sa.Column("sfdata_as_of", sa.DATE(), autoincrement=False, nullable=False),
        sa.Column(
            "sfdata_loaded_at",
        ...
        sa.PrimaryKeyConstraint("eas_fullid", name="address_pkey"),
    )
    op.create_table(
        "loader_variables",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
            "address", sa.VARCHAR(length=50), autoincrement=False, nullable=False
        ),
        sa.Column(
            "soft_story_risk",
            sa.BOOLEAN(),
        ...
        sa.PrimaryKeyConstraint("id", name="combined_risk_pkey"),
        sa.UniqueConstraint("address", name="combined_risk_address_key"),
    )
    op.create_table(
        "place",
        sa.Column("gid", sa.INTEGER(), autoincrement=True, nullable=False),
