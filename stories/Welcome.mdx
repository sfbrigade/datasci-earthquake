...
import Github from "./examples/assets/github.svg";
import Discord from "./examples/assets/discord.svg";
import Youtube from "./examples/assets/youtube.svg";
import Tutorials from "./examples/assets/tutorials.svg";
import Styling from "./examples/assets/styling.png";
import Context from "./examples/assets/context.png";
import Assets from "./examples/assets/assets.png";
import Docs from "./examples/assets/docs.png";
import Share from "./examples/assets/share.png";
import FigmaPlugin from "./examples/assets/figma-plugin.png";
import Testing from "./examples/assets/testing.png";
import Accessibility from "./examples/assets/accessibility.png";
import Theming from "./examples/assets/theming.png";
import AddonLibrary from "./examples/assets/addon-library.png";
...
<Meta title="SafeHome Design System" />

<div className="sb-container">
  <div className="sb-section-title">
    # SafeHome Design System
    This is the design system for [https://safehome.report](https://safehome.report).
  </div>
  <div className="sb-section">
    <div className="sb-section-item">
      This is a work in progress brought to you by [San Francisco Civic Tech](https://sfcivictech.org). You can help contribute at [https://github.com/sfbrigade/datasci-earthquake](https://github.com/sfbrigade/datasci-earthquake) or join our [weekly Hack Night or Slack](https://sfcivictech.org).
    </div>
  </div>
  <div className='sb-section-title'>
